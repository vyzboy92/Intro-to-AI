# Computer Vision
Accubits provides AI services and solutions for computer vision use cases. We have a strong portfolio of vision products under the Emotyx branding, 
where we serve clients across the globe. Use case specific data engineering, model selection, model fine-tuning, pipeline architecting, optimisation, and deployment
are done in-house. This document features a curated list of learning materials which lets you gain in-depth knowledge on computer vision techniques, digital image processing, neural networks, etc.
The core learning material is based on Stanford CS Class: cs231n.
